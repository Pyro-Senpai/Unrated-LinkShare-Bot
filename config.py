...
START_MSG = os.environ.get("START_MSG", "<b><blockquote>● Wᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ᴀᴅᴠᴀɴᴄᴇᴅ ʟɪɴᴋs sʜᴀʀɪɴɢ ʙᴏᴛ!</blockquote></b>\n<b><blockquote expandable>● Tʜɪs ʙᴏᴛ ɪs ᴀn ᴇxᴄʟᴜsɪᴠᴇ ɢᴀᴛᴇᴡᴀʏ ғᴏʀ oᴜʀ cᴏᴍᴍᴜɴɪᴛʏ tᴏ ᴀᴄᴄᴇss cᴏɴᴛᴇɴᴛ sᴇᴄᴜʀᴇʟʏ. ᴘʟᴇᴀsᴇ ᴜsᴇ ᴛʜᴇ ʟɪɴᴋs ᴘʀᴏᴠɪᴅᴇᴅ ɪɴ ᴛʜᴇ ᴍᴀɪɴ cʜᴀɴɴᴇʟ ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇs.</blockquote></b>\n<b><blockquote>● Tʜɪs ɪs ᴀ ᴘʀɪᴠᴀᴛᴇʟʏ ᴍᴀɴᴀɢᴇᴅ sʏsᴛᴇᴍ ᴛᴏ ᴘʀᴏᴛᴇᴄᴛ oᴜʀ cᴏɴᴛᴇɴᴛ ғʀᴏᴍ cᴏᴘʏʀɪɢʜᴛ ɪꜱsᴜᴇs.</blockquote></b>")
